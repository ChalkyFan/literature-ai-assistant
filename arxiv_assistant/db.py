    ...
    try:
        ...
        cursor = conn.execute("""
            ...
            INSERT OR IGNORE INTO papers
                ...
                (arxiv_id, title, authors, affiliations, abstract, categories, published_date, pdf_path, source, fetched_date, uploaded_by)
    ...
    try:
        ...
        if source:
            ...
            rows = conn.execute(
                ...
                "WHERE date(p.fetched_date) = ? AND p.source = ? "
